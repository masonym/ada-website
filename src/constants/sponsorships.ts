        ...
        sponsorships: [
            {
                ...
                cost: "$7,000",
                perks: [
                    { tagline: "Event Access", description: " (4) VIP Attendee Passes. Additional VIP Attendee Passes can be Purchased for $395 each" },
                    ...
                    { tagline: "VIP Introductions", description: "Strategic Introductions to Key Speakers and VIP Guests under Speaking Opportunity for Gold Sponsor"},
                    { tagline: "Exhibit Space", description: "8'x10' Exhibit Space Strategically Placed in Exhibit Hall/Foyer. 6' Exhibit Table and 2 Chairs" },
