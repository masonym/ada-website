  ...
  },
  {
    ...
    eventText: (
      <div className="max-w-[92rem] font-light text-balance">
        <div className="p-4 border-black border-4 bg-white w-fit text-5xl text-red-500 font-bold mx-auto rounded-lg mb-4 flex items-center"><span className="mr-2"><CircleAlert size={48} color="#c53434" /></span>Event registration is now closed.</div>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center font-gotham text-slate-700 mb-6">
          Event Overview
        </h2>
