...
export const EXHIBITOR_TYPES: ExhibitorEventType[] = [
    ...
    exhibitors: [
      {
        ...
        perks: [
          ...
          {
            tagline: "Networking",
            description: "2 VIP Networking Reception Passes",
          },
          {
            tagline: "Display Space",
            description: "6' Display Table in General Session",
          },
          {
            tagline: "Full Access",
            description: "Access to All Event Sessions",
          },
          {
            tagline: "Resources",
            description: "Speaker Presentations and Materials",
          },
          {
            tagline: "Documentation",
            description: "Digital/Physical Copies of Agenda",
          },
          { tagline: "Dining", description: "Buffet Lunch" },
          {
            tagline: "Media Access",
            description: "Access to Photos & Videos from Conference",
          },
        ],
        ...
        perks: [
          {
            ...
            description:
              " (1) Exhibitor Pass. Additional Passes can be Purchased for $395 each",
          },
          {
            tagline: "Exhibit Space",
            description:
              "8'x10' Exhibit Space Placed in Exhibit Area/Foyer. 6' Exhibit Table and Chairs",
          },
          {
            tagline: "Brand Visibility",
            description:
              "Logo Placement on select Conference Materials, including Marketing Emails and Website",
          },
          {
            tagline: "Recognition",
            description:
              "Acknowledgement before Networking Breaks at the Conference",
          },
          {
            tagline: "Media Coverage",
            description: "Photographs of your Participation",
          },
        ],
        colour: "#3FB4E6",
        shownOnRegistrationPage: true,
  ...
  },
  {
    ...
    additionalPass: {
      ...
      description:
        "For registered Exhibitors. Purchase additional Exhibitor passes for your team at a discounted rate. A valid order ID from a previous Exhibitor or Sponsor registration is required.",
      price: 395,
        ...
        perks: [
          ...
          },
          {
            formatted: [
              ...
              {
                content: "8'x10' Table-Top Exhibit Space in Exhibit Hall/Foyer",
                indent: 1,
              },
