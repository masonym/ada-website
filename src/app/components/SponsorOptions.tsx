    ...
    return (
        <div className="max-container mx-auto pb-8 pt-0 px-4 flex flex-col items-center ">
            <div className="flex flex-col items-center">
                ...
                Explore our exclusive discounted Sponsorship Opportunities available when you Register for Multiple Events. Inquire about Sponsorship Opportunities available without an Exhibit Space at a reduced rate. For more information and to secure your sponsorship, contact: <br></br>
