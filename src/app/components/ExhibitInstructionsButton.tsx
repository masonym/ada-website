...
/**
 * Link to the event's exhibitor instructions PDF.
 *
...
interface ExhibitInstructionsButtonProps {
  /** Resolved instructions URL, or null when the event has none uploaded. */
  href?: string | null;
}

const ExhibitInstructionsButton: React.FC<ExhibitInstructionsButtonProps> = ({ href }) => {
  if (!href) return null;
