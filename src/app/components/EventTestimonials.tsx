  ...
  return (
    <section className="pb-4">
      <div className="container mx-auto px-4">
        {showTitle && (
          <h2
            className="text-3xl md:text-4xl font-semibold text-center mb-8 md:mb-12 text-slate-700"
            dangerouslySetInnerHTML={{
              __html: title || "Attendee Testimonials",
            }}
          ></h2>
        )}
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                    <div className="flex-shrink-0">
                      <Image
                        ...
                        alt={
                          testimonial.imageAlt || `${testimonial.name} headshot`
                        }
                        width={80}
                        height={80}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-500 text-sm">
                        {testimonial.title} at {testimonial.affiliation}
                      </p>
                    </div>
                  </div>
                ) : (
