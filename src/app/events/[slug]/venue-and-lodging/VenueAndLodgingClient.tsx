...
/**
 * Venue & lodging. Client-side only for the two accordions - the event is
 * resolved on the server in page.tsx and passed in, so this no longer imports
 * EVENTS (and no longer calls React.use(params) mid-component).
 */
export default function VenueAndLodgingClient({ event }: { event: Event }) {
