 ...
 * is resolved on the server in page.tsx and passed in, so this no longer imports
 * EVENTS and searches it by useParams().slug.
 */
const VenuePageClient = ({ event }: { event: Event }) => {
...
export default VenuePageClient;